      ...
      <main className="flex-1 h-full flex justify-center items-center flex-col gap-5">
        ...
        <form className='w-full md:w-96 lg:w-[500px]'>
          ...
          <div>
            ...
            <input type="email" id='pass' placeholder='********' className='w-full p-3 bg-transparent focus:border-black rounded-lg outline-none border-2 border-neutral-200 mt-1 mb-3' />
          </div>
