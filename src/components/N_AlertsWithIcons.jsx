...
import { IoCloseSharp, IoNotificationsCircleOutline } from 'react-icons/io5';
...
const N_Alerts = () => {
   ...
   <section className="bg-white border-2 border-neutral-200 shadow-lg p-4 md:p-8 rounded-lg">
      <h1 className="font-semibold text-xl mb-5">Alerts with Icon</h1>
      <ul className="flex flex-col gap-3">
         {nots.map((not,index) => (
               ...
               <p className="text-white flex gap-2"><IoNotificationsCircleOutline className='text-xl md:text-2xl' />{not.message}</p>
               <div className="text-white text-xl sm:text-2xl cursor-pointer flex gap-3">
