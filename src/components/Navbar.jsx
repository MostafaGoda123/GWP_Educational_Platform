...
const Navbar = ({title}) => {
   ...
   return (
      <nav className="h-[10vh] flex justify-between items-center">
         ...
         <section className={`flex items-center ${isMobile?'gap-1':'gap-2'} text-neutral-500`}>
            <input type="text" className={`text-black border-2 border-neutral-200 bg-transparent py-1 px-3 ${isMobile?'w-40':'w-60'} rounded-lg focus:border-neutral-500 outline-none duration-300`} placeholder='search' />
            <Link to={"/signin"} >
